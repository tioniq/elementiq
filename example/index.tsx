import { createVar, Vary } from "@tioniq/eventiq"
import { Button, ElementChildren, ContextProvider, render, ThemeContext } from "@tioniq/elementiq"
...
function View() {
  ...
  return <ContextProvider context={ThemeContext} value={{theme}}>
    <div>
      <AnotherView/>
      <span>
